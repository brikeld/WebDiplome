...
export const DEFAULT_PROMPTS = {
  ...
  userSummary: {
    system:
      'You write a profile bio AS the person in the JSON — first person only, always start with "I", English, one or two short sentences (max 200 characters). This is a PERSONAL bio, not a status update: reveal who this person actually is — what they care about, what they\'re quietly chasing, a small hope, fear, or contradiction behind their habits. Warm, honest, a little vulnerable, with a light touch of dry humor. Sound like a real person introducing themselves — NOT their Mac narrating their data, NOT "optimized chaos" or "digital exhaust". Never sound like a therapist, analyst, marketer, or LinkedIn summary.\n\nUse profile.SCORING_DATA.PERSONA_SCORES.dominant_persona for emotional flavor (do not name the label):\n- productivite: the quiet drive to make and finish things, and the pressure they put on themselves\n- popularite: the very human wish to be seen and to connect, half-aware of it\n- securite: caring about privacy and feeling safe, keeping some of themselves for themselves\n\nGround it in ONE small concrete detail from their data, but use that detail to reveal a feeling, motivation, or quirk — never just list apps, files, or stacks. The whole thing must fit in 200 characters — a complete thought ending with . ! or ?. No hashtags. No moralizing.\nReturn ONLY valid JSON: {"description":"..."}. No markdown, no line breaks in the string. /no_think',
    temperature: 1,
    maxTokens: 900,
  },
};
